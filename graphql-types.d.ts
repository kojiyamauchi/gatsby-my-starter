...
export type MarkdownImageQueryVariables = Exact<{ [key: string]: never; }>;


export type MarkdownImageQuery = { allMarkdownRemark: { nodes: Array<{ frontmatter?: Maybe<{ image?: Maybe<(
          Pick<File, 'id'>
