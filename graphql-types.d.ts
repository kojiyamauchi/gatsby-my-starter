...
export type SitePageContextFilterInput = {
  ...
  current?: Maybe<IntQueryOperatorInput>;
...
export type Unnamed_1_Query = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

export type Unnamed_2_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_2_Query = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

export type Unnamed_3_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_3_Query = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

export type Unnamed_4_QueryVariables = Exact<{ [key: string]: never; }>;


export type Unnamed_4_Query = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };

export type BlogCategoryQueryVariables = Exact<{
...
export type BlogCategoryQuery = { allMarkdownRemark: { edges: Array<{ node: (
...
export type BlogPostQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'categories' | 'date' | 'description' | 'title'>
      & { image?: Maybe<(
        Pick<File, 'id'>
        & { childImageSharp?: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }
      )> }
